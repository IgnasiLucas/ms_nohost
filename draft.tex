...
\raggedright
\thispagestyle{empty}
{\Large\bfseries\sffamily The strange evolution of a group hostless
parasites}
\vskip 5em

%
Juan Antonio\,Balbuena Díez-Pinés%
%
...
\textsuperscript{1}\,Universitat de
València\quad \textsuperscript{2}\,Institut Cavanilles de Biodiversitat
i Biologia Evolutiva\quad \textsuperscript{3}\,Green Dragon
Inn\quad \textsuperscript{4}\,Fellowship of the Ring

\textsuperscript{‡}\,These authors contributed equally to the work\\

\textbf{Correspondance to:}\\
Juan Antonio Balbuena Díez-Pinés --- \texttt{j.a.balbuena@uva.es}\\
